<template>
    <div class="register">
      <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
        <h3 class="title">物流后台管理系统</h3>
        <el-form-item prop="username">
          <el-input v-model="registerForm.loginName" type="text" auto-complete="off" placeholder="账号">
        ...
        this.$refs.registerForm.validate(valid => {
          if (valid) {
            ...
            register(this.registerForm).then(res => {
              const loginName = this.registerForm.loginName;
              this.$alert("<font color='red'>恭喜你，您的账号 " + loginName + " 注册成功！</font>", '系统提示', {
