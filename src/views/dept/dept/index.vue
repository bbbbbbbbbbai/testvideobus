<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
                        ...
                        <el-form-item label="单位地点" prop="address">
                            <el-input
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button
                        ...
                        :disabled="multiple"
                        @click="handleDelete"
                        v-hasPermi="['dept:dept:remove']"
                >删除</el-button>
            </el-col>
            <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
        </el-row>

        <el-table v-loading="loading" :data="deptList" @selection-change="handleSelectionChange" @sort-change="handleSortChange">
            <el-table-column type="selection" width="55" align="center" />
                    <el-table-column label="ID" align="center" prop="id" sortable="custom"/>
                    <el-table-column label="单位名称" align="center" prop="name" sortable="custom"/>
                    <el-table-column label="单位地点" align="center" prop="address" sortable="custom"/>
                    <el-table-column label="电话" align="center" prop="phone" sortable="custom"/>
                    <el-table-column label="联系人" align="center" prop="contactor" sortable="custom"/>
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                                ...
                                <el-form-item label="单位地点" prop="address">
                                    <el-input v-model="form.address" placeholder="请输入单位地点" />
                                </el-form-item>
                                <el-form-item label="电话" prop="phone">
    ...
    export default {
        ...
        data() {
            ...
            rules: {
                        ...
                        address: [
                        { required: true, message: "单位地点不能为空", trigger: "blur" }
                    ],
            }
        };
        },
        ...
        methods: {
            ...
            handleDelete(row) {
                ...
                this.$modal.confirm('是否确认删除调阅单位编号为"' + ids + '"的数据项？').then(function() {
                    return delDept(ids);
                }).then(() => {
                    this.getList();
