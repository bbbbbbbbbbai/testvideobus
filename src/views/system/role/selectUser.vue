  ...
  <el-dialog title="选择用户" :visible.sync="visible" width="800px" top="5vh" append-to-body>
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="userList" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="创建时间" align="center" prop="updateInfo.createdTime" width="180">
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="primary" @click="handleSelectUser" v-hasPermi="['system:role:allocateUser']">确 定</el-button>
...
<script>
  import {unallocatedUserList, addRoleUsers} from "@/api/system/role";
  ...
  export default {
    ...
    methods: {
      ...
      handleSelectUser() {
        ...
        addRoleUsers({roleId: roleId, userIds: userIds}).then(res => {
